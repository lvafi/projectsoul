...
function slider_init() {
  ...
  if (size < 1025) {
    ...
    jQuery('.yellow-slider').slick({
      ...
      prevArrow:
        '<button type="button" class="slick-prev"><span class="control-icon fa-chevron-left fa-lg"></span><span class="control-previous">PREV</span></button>',
      nextArrow:
        '<button type="button" class="slick-next"><span class="control-next">NEXT</span><span class="control-icon fa-chevron-right fa-lg"></span></button>'
    });
  } else {
    ...
    jQuery('.yellow-slider').slick({
      ...
      appendArrows: controls,
      prevArrow:
        '<button type="button" class="slick-prev"><span class="control-icon fa-chevron-left fa-lg"></span><span class="control-previous">PRVE</span></button>',
      nextArrow:
        '<button type="button" class="slick-next"><span class="control-next">NEXT</span><span class="control-icon fa-chevron-right fa-lg"></span></button>'
    });
